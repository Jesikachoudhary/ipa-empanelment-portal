            ...
            <div class="body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="date" name="date_of_birth" class="form-control @error('date_of_birth') is-invalid @enderror" value="{{ old('date_of_birth', $applicant->date_of_birth?->format('Y-m-d')) }}">
